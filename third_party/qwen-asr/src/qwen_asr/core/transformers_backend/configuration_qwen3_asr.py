...
class Qwen3ASRConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Set thinker_config before super().__init__(): transformers 5.x runs
        # huggingface_hub strict validation (validate_token_ids -> get_text_config
        # -> self.thinker_config) during super().__init__, so the attribute must
        # exist before that call. On 4.57 this reorders harmless initialization.
