...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="auto",
        choices=["auto", "mlx-whisper", "faster-whisper", "whisper", "openai-api", "funasr", "voxtral", "voxtral-mlx", "nemotron-mlx-asr", "qwen3-vllm", "qwen3-vllm-metal", "qwen3-streaming", "mlx-qwen3-asr", "canary"],
